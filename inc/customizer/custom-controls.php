 ...
 */
class Architectonic_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Architectonic_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Architectonic_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="architectonic-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Architectonic_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Architectonic_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="architectonic-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'architectonic' ); ?>" class="architectonic-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Architectonic_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
