...
class Architectonic_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'architectonic';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'architectonic' ), $i ),
...
// Initialize.
$architectonic_footer_widgets = new Architectonic_Footer_Widgets();
