...
function architectonic_scripts() {
	...
	// swiper theme
	wp_enqueue_style( 'swiper', get_template_directory_uri() . '/assets/css/swiper' . architectonic_min() . '.css' );
	...
	wp_enqueue_script( 'architectonic-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );
	...
	wp_enqueue_script( 'jquery-swiper', get_template_directory_uri() . '/assets/js/swiper' . architectonic_min() . '.js', array( 'jquery' ), '', true );
